...
public class Main {
    public static void main(String[] args) {
        ...
        Patron patron1 = new Patron("P1", "ABHINAV KAMBOJ", "abhinavkamboj8@gmail.com", 872821213, "kullu h kullu");
        Patron patron2 = new Patron("P2", "AHANA CHANDA", "ahana.chanda101@gmail.com", 324232213, "kolkata h kolkata");
