...
public abstract class Library {
    ...
    abstract public void updatePatronInformation(Patron patron, Optional<String> newPatronId, Optional<String> newPatronName, Optional<String> newPatronAddress, Optional<String> newPatronPhone, Optional<String> newPatronEmail);
